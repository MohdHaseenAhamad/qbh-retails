...
class User extends Authenticatable implements HasMedia
{
    ...
    public function checkAccess($data)
    {
        ...
        // dd($data);
        // if($data->data['ability'] == 'view-invoice'){
            // dd($this->can($data->data['ability'], $data->data['model']));
            // dd($this);
            // dd($data->data['ability']);
            // dd($data->data['model']);
            // dd($data->data);
            // dd($this->can($data->data['ability'], $data->data['model']));
        // }
        ...
        if ((! $data->data['owner_only']) && $this->can($data->data['ability'])) {
            // if($data->data['ability'] == 'manage-bank'){
                // dd($data->data['ability']);
            // }
    ...
    public function getFilterPDFData($users, $query_data)
    {
        // dd($query_data);
        ...
        view()->share([
            ...
            return PDF::loadView('app.pdf.filtered.user');
    }
}
