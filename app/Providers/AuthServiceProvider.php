...
use Crater\Policies\PreparedByPolicy;
...
use Crater\Policies\CreditPolicy;
use Crater\Policies\DebitPolicy;
use Crater\Policies\SupplierPolicy;
use Crater\Policies\PurchasePolicy;
use Crater\Policies\ProformaPolicy;
use Crater\Policies\StorePolicy;
...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        \Crater\Models\Credit::class => \Crater\Policies\CreditPolicy::class,
        ...
        \Crater\Models\PreparedBy::class => \Crater\Policies\PreparedByPolicy::class,
    ...
    public function boot()
    {
        ...
        // Gate::define('manage bank', [SettingsPolicy::class, 'manageBank']);
        ...
        Gate::define('delete multiple credit notes', [CreditPolicy::class, 'deleteMultiple']);
        Gate::define('delete multiple debit notes', [DebitPolicy::class, 'deleteMultiple']);
        Gate::define('delete multiple purchases', [PurchasePolicy::class, 'deleteMultiple']);
        Gate::define('delete multiple proformas', [ProformaPolicy::class, 'deleteMultiple']);
        Gate::define('delete multiple stores', [StorePolicy::class, 'deleteMultiple']);
    }
}
