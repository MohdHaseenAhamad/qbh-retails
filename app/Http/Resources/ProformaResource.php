...
class ProformaResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'recurring_proforma_id' => $this->recurring_proforma_id,
            ...
            'proforma_pdf_url' => $this->proformaPdfUrl,
            'formatted_proforma_date' => $this->formattedproformaDate,
            ...
            'items' => $this->when($this->items()->exists(), function () {
                return ProformaItemResource::collection($this->items);
            }),
