...
class DashboardController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $invoices_with_is_edit_null = Invoice::whereCompany()->whereNull('is_edit')->get();
        foreach($invoices_with_is_edit_null as $invoice)
        {
            $invoice->update([
                'is_edit' => '0',
                'sent' => true,
        ...
        $quotations_with_is_edit_null = Estimate::whereCompany()->whereNull('is_edit')->get();
        foreach($quotations_with_is_edit_null as $quotation)
        {
            $quotation->update([
                'is_edit' => '1',
