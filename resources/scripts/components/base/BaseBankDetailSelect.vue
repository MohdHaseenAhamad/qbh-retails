<template>
  <div class="flex-1 text-sm">
    ...
    <BaseMultiselect
      ...
      :invalid="invalid"
      preserve-search
      :initial-search="itemData.account_no"
      label="bank_name"
      :filterResults="false"
      resolve-on-load
      :delay="500"
...
async function searchItems(search) {
  let res = await bankDetailStore.fetchBankDetails({ search })
...
function deselectBankDetail() {
  props.store.deselectBankDetail()
}
</script>
