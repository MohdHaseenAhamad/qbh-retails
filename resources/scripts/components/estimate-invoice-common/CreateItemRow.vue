      ...
      <table class="w-full">
        ...
        <tbody>
          <tr>
                ...
                <div class="flex flex-col">
                  <div class="flex" role="group">
                    <BaseInput
                      ...
                      "
                    />
                    <BaseDropdown position="bottom-end" class="w-16">
                      <template #activator >
                        <BaseButton
                          :content-loading="loading"
                      ...
                      <BaseDropdownItem v-if="isDraftMode" @click="selectFixed">
                        {{ $t('general.fixed') }}
                      </BaseDropdownItem>

                      <BaseDropdownItem v-if="isDraftMode" @click="selectPercentage">
            ...
            <td class="px-5 py-4 text-right align-top" v-if=isDraftMode>
          ...
          <tr v-if="store[storeProp].tax_per_item === 'YES'">
            ...
            <td colspan="4" class="px-5 py-4 text-left align-top">
              ...
              <ItemTax
                ...
                :total="subtotal"
                :discount ="itemData.discount_val"
                :currency="currency"
...
const unit_name = computed({
  get: () => {
    const unit_name = props.itemData.unit_name
    return unit_name
  },
  set: (newValue) => {
...
const total = computed(() => {
  console.log('subtotal.value | props.itemData.discount_val')
  console.log((subtotal.value/100) +" | "+ (props.itemData.discount_val/100))
...
function reCalculateDiscountVal(){
  // updateItemAttribute(
  //   'discount_val',
  //   (subtotal.value * props.itemData.discount) / 100
  // )
