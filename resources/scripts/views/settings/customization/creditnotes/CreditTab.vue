<template>
  <CreditTabPaymentNumber />

  <BaseDivider class="my-8" />

  <CreditTabDefaultFormats />
...
import CreditTabPaymentNumber from './CreditTabPaymentNumber.vue'
import CreditTabDefaultFormats from './CreditTabDefaultFormats.vue'
