<template>
  <DebitTabPaymentNumber />

  <BaseDivider class="my-8" />

  <DebitTabDefaultFormats />
...
import DebitTabPaymentNumber from './DebitTabPaymentNumber.vue'
import DebitTabDefaultFormats from './DebitTabDefaultFormats.vue'
