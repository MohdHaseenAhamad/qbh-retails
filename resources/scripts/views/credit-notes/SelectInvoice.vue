  ...
  <BasePage class="relative payment-create">
    <form action="" @submit.prevent="submitPaymentData">
        ...
        <BaseCard>
          ...
          <h3>Please select customer and invoice to generate credit note</h3><br>
...
function onCustomerChange(customer_id) {
  if (customer_id) {
    ...
    Promise.all([
      invoiceStore.fetchInvoices(data, true),
...
async function submitPaymentData() {
  ...
  router.push(`/admin/credit-note/${paymentStore.currentPayment.invoice_id}/create`)
}
