    ...
    >
      ...
      <div class="pt-6">
        <router-link
          ...
          :to="`/filtered-quotations-list?selectedCompany=${companyStore.selectedCompany.id}&customer_id=${filters.customer_id}&status=${filters.status}&from_date=${filters.from_date}&to_date=${filters.to_date}&estimate_number=${filters.estimate_number}`"
          target="_blank"
        >
