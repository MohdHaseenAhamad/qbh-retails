      ...
      <BaseScrollPane>
        ...
        >
          ...
          <BaseInputGrid class="sm:grid-cols-4 md:grid-cols-4 col-span-12 mb-4">
            ...
            />
            <BaseInputGroup
              :label="$t('estimates.subject')"
              :content-loading="isLoadingContent"
            >
              <BaseInput
                v-model="estimateStore.newEstimate.subject"
                :content-loading="isLoadingContent"
              />
            </BaseInputGroup>
...
async function submitForm() {
  ...
  let data = {
    ...
    prepared_by_id:estimateStore.newEstimate.prepared_by_id ? estimateStore.newEstimate.prepared_by_id.id : '',
    bank_detail_id:estimateStore.newEstimate.bank_detail_id ? estimateStore.newEstimate.bank_detail_id.id : ''
  }
