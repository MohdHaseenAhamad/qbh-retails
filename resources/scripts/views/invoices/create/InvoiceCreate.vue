      ...
      <BaseScrollPane>
        ...
        <BaseInputGrid class="sm:grid-cols-4 md:grid-cols-4 col-span-12 mb-4">
          ...
          <InvoiceCustomFields
            ...
            :disable="(invoiceStore.newInvoice.is_edit ? (invoiceStore.newInvoice.is_edit == '1' ? false : true) : false)"
          />
...
const isDraftMode = computed(() => {
  // alert(invoiceStore.newInvoice.is_edit == 1 ? true : false)
  return invoiceStore.newInvoice.is_edit == 1 ? true : false
})
...
async function submitForm() {
  ...
  let data = {
    ...
    prepared_by_id:invoiceStore.newInvoice.prepared_by_id ? invoiceStore.newInvoice.prepared_by_id.id : '',
    bank_detail_id:invoiceStore.newInvoice.bank_detail_id ? invoiceStore.newInvoice.bank_detail_id.id : ''
  }
