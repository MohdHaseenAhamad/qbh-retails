  ...
  <BasePage class="payments">
    ...
    <BaseFilterWrapper :show="showFilters" class="mt-3" @clear="clearFilter">
      ...
      <router-link
        ...
        :to="`/filtered-payments-list?selectedCompany=${companyStore.selectedCompany.id}&customer_id=${filters.customer_id!= undefined ? filters.customer_id : ''}&payment_number=${filters.payment_number}&payment_method_id=${filters.payment_mode}`"
        target="_blank"
      >
    ...
    <div v-show="!showEmptyScreen" class="relative table-container">
      ...
      >
        ...
        <!-- Payment status  -->
        <template #cell-modestatus="{ row }">
          <BasePaymentStatusBadge :status="row.data.status" class="px-3 py-1">
            {{ row.data.status }}
