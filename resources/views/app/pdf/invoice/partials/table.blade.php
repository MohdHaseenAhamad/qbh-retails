...
<div class="total-display-container">
    <table width="100%" cellspacing="0px" border="0" class="price_table total-display-table @if(count($invoice->items) > 12) page-break @endif">
                <tr>
                    <td class="border" rowspan="10" width="40%" style="border-bottom:2px solid black;text-align:center;text-transform: capitalize;font-size:10px;"><strong><span class="arabic" >{{\Lang::get('Amount in words',[],'ar')}}</span> / {{\Lang::get('Amount in words',[],'en')}}</strong>
