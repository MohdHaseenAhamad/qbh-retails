...
<body>
    ...
    <div class="wrapper" style="padding-top: 130px;">
        ...
        <div class="customer-address-container">
            ...
            <p style="font-size: 12px;color:#595959;width:50%;">{{$estimate->subject ?? 'NA'}}</p>
        ...
        <div class="reference-line">
            <p>Dear Sir, With reference to your enquiry, please find our competitive Quotation as follow: </p>
        </div>
