...
<body>
    ...
    <div>
        <table width=100% class="invoice_no">
            <tr >
                <td width="50%" colspan="1">{{\Lang::get('Credit Note No',[],'en')}}:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{$invoice->credit_number}}</span></td>
                <td dir="rtl"><span class="arabic" >{{\Lang::get('Credit Note No',[],'ar')}}:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{$invoice->credit_number}}</span></td>
            </tr>
        </table>
    </div>
    <div class="content-wrapper">
        ...
        <div width="100%" style="">
            <table class="client_table" width=100% >
                ...
                <tr>
                    <td class="border background_client">{{\Lang::get('Street Name',[],'en')}}</td>
                    <td colspan="3" class="border">{{$client_details['address']['address_street_1'] ?? 'NA'}}</td>

                    <td colspan="3" class="border" dir="rtl"><span class="arabic" >{{$client_details['address_street_1_ar'] ?? 'NA'}}</span></td>
                    <td class="border background_client" dir="rtl"><span class="arabic" >{{\Lang::get('Street Name',[],'ar')}}</span></td>
                </tr>
                <tr>
                    <td class="border background_client">{{\Lang::get('Building No',[],'en')}}</td>
                    <td class="border" width="16%">{{$client_details['address']['address_street_2'] ?? 'NA'}}</td>
                    <td class="border background_client" width="12%">{{\Lang::get('State/Province',[],'en')}}</td>
                    <td class="border" width="12%">{{$client_details['address']['state'] ?? 'NA'}}</td>

                    <td class="border" dir="rtl"  width="12%"><span class="arabic" >{{$client_details['state_ar'] ?? 'NA'}}</span></td>
                    <td class="border background_client"  width="12%" dir="rtl"><span class="arabic" >{{\Lang::get('State/Province',[],'ar')}}</span></td>
                    <td class="border" dir="rtl" width="16%"><span class="arabic" >{{$client_details['address_street_2_ar'] ?? 'NA'}}</span></td>
                ...
                <tr>
                    ...
                    <td class="border background_client">{{\Lang::get('District',[],'en')}}</td>
                    <td class="border">{{$client_details['address']['city'] ?? 'NA'}}</td>

                    <td class="border" dir="rtl"><span class="arabic" >{{$client_details['city_ar'] ?? 'NA'}}</span></td>
                    <td class="border background_client" dir="rtl"><span class="arabic" >{{\Lang::get('District',[],'ar')}}</span></td>
                ...
                <tr>
                    <td class="border background_client">{{\Lang::get('Postl Code',[],'en')}}</td>
                    <td class="border">{{$client_details['address']['zip'] ?? 'NA'}}</td>
                    <td class="border background_client">{{\Lang::get('CR No',[],'en')}}</td>
                    <td class="border"><strong>{{$client_details['prefix'] ?? 'NA'}}</strong></td>

                    <td class="border" dir="rtl"><strong><span class="arabic" >{{$client_details['prefix_ar'] ?? 'NA'}}</span></strong></td>
                    <td class="border background_client" dir="rtl"><span class="arabic" >{{\Lang::get('CR No',[],'ar')}}</span></td>
                    <td class="border" dir="rtl"><span class="arabic" >{{$client_details['zip_ar'] ?? 'NA'}}</span></td>
                    <td class="border background_client" dir="rtl"><span class="arabic" >{{\Lang::get('Postl Code',[],'ar')}}</span></td>
                </tr>
                <tr>
                    <td class="border background_client">{{\Lang::get('VAT Number',[],'en')}}</td>
                    <td class="border" colspan="3"><strong>{{$client_details['website'] ?? 'NA'}}</strong></td>
                    <td class="border" colspan="3" dir="rtl"><strong><span class="arabic" >{{$client_details['website_ar'] ?? 'NA'}}</span></strong></td>
                    <td class="border background_client" dir="rtl"><span class="arabic" >{{\Lang::get('VAT Number',[],'ar')}}</span></td>
        ...
        <div width="100%">
            <table width="100%" cellspacing="0px"  class="total-display-table price_table @if(count($invoice->items) > 12) page-break @endif">
                ...
                <tr>
                    <td class="border  total-table-attribute-label">
                        <span dir="rtl" class="arabic" >{{\Lang::get('pdf_total_amount',[],'ar')}}</span> / {{\Lang::get('pdf_total_amount',[],'en')}}
                    </td>
                    <td
                        class="py-8 border item-cell total-table-attribute-value"
                        style="color: #00008B"
        ...
        <div width="100%">
            <table class="bank_table" width="100%">
                <tr class="tr_blue">
                    <th class="border" width="40%;" style="height:20px;"><span class="arabic" >{{\Lang::get('Prepared By',[],'ar')}}</span><br>{{\Lang::get('Prepared By',[],'en')}}</th>
                    <th class="border" width="40%;" style="height:20px;"><span class="arabic" >{{\Lang::get('Recieved By',[],'ar')}}</span><br>{{\Lang::get('Recieved By',[],'en')}}</th>
                ...
                <tr>
                    <td class="border" style="text-align:center;" rowspan="8">
                        @if($signature)
                            @if($signature_image)
                                <img style="max-width: 150px; " src="{{ $signature_image }}" alt="prepared_by signature"><br>
                            @endif

                            <strong>{{$signature->name}}</strong><br>
                        @endif
                    </td>
                    <td rowspan="8" class="border" style="text-align:center;">
