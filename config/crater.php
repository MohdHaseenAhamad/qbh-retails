...
return [
    ...
    */
    'retrospective_edits' => [
        ...
        ['key' => 'settings.preferences.disable_on_proforma_partial_paid', 'value' => 'disable_on_proforma_partial_paid'],
        ['key' => 'settings.preferences.disable_on_proforma_paid', 'value' => 'disable_on_proforma_paid'],
        ['key' => 'settings.preferences.disable_on_proforma_sent', 'value' => 'disable_on_proforma_sent'],
    ],
    ...
    */
    'setting_menu' => [
        ...
        [
            'title' => 'settings.company_info.licence.detail',
            'group' => '',
            'name' => 'Account Settings',
        ...
        [
            'title' => 'settings.bankdetail.bank_detail',
            'group' => '',
            'name' => 'Bank Details',
            'link' => '/admin/settings/bank-details',
            'icon' => 'CollectionIcon',
            'owner_only' => false,
            'ability' => 'manage-bank',
            'model' => ''
    ...
    */
    'main_menu' => [
        ...
        [
            'title' => 'navigation.proformas',
            'group' => 2,
            'link' => '/admin/proformas',
            'icon' => 'AnnotationIcon',
            'name' => 'Proformas',
            'owner_only' => false,
